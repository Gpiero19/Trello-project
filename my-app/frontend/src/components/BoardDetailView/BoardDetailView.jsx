...
function BoardsDetailView() {
  ...
  const handleDragEnd = async (result) => {
    ...
    if (type === "CARD") {
      const sourceListIndex = board.lists.findIndex(l => `list-${l.id}` === source.droppableId);
      const destListIndex = board.lists.findIndex(l => `list-${l.id}` === destination.droppableId);
